...
const Bisection = () => {
  ...
  const [iterations, setIterations] = useState(null);
    ...
    let iterations_inputed = document.querySelector(".iterations-input").value;
      ...
      console.log(initial_a_inputed)
      console.log(number_regex.test(initial_a_inputed))
      console.log(typeof(initial_a_inputed))
      ...
      console.log(number_regex.test(initial_b))
    ...
    setIterations(iterations_inputed)
		const body = {
			...
			initial_x0: parseFloat(initial_a_inputed),
			initial_x1: parseFloat(initial_b_inputed),
	...
	return (
		<div className="mt-3">
			<h2 className="text-center mt-2">Secant</h2>
